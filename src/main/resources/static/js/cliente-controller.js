...
appCliente.controller("clienteController", function ($scope, $http) { 
	...
	$scope.carregarClientes = function(){
		$http({method:'GET', url:'http://localhost:8080/TaskManager/cliente'})
	...
	$scope.salvarCliente = function(){
		$http({method:'POST', url:'http://localhost:8080/TaskManager/cliente', data:$scope.cliente})
		.then(function (response){
	...
	$scope.excluirCliente = function (cliente) {
		$http({method:'DELETE', url:'http://localhost:8080/TaskManager/cliente/'+cliente.id})
		.then(function (response){
